...
if __name__ == "__main__":
    ...
    tokenizer, model = load_translation_model(device, mem)
    test_texts = [
        "Hello, how are you?",
        "This is a test sentence for translation."
    ]
    print("Chunking texts...")
    chunks = chunk_text(test_texts, chunk_char_limit=50)
    print("Translating chunks...")
    results = translate_chunks(chunks, tokenizer, model, device)
    print("\nTranslation results:")
    for res in results:
        print(res)